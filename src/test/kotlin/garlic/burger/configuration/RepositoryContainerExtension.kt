...
class RepositoryContainerExtension: BeforeAllCallback {
    ...
    override fun beforeAll(context: ExtensionContext?) {
        ...
        System.setProperty("spring.datasource.url", "jdbc:mariadb:aurora://localhost:${mysqlContainer.getMappedPort(MYSQL_PORT)}/${DATABASE_NAME}?useSSL=false&useUnicode=true&characterEncoding=UTF-8&useFractionalSeconds=false")
